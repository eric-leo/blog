...
[koajs](https://koajs.com/) Koa2是现在最流行的基于Node.js平台的web开发框架
...
![img.jpg](https://tva1.sinaimg.cn/large/007S8ZIlgy1gfd797mrzuj30us0h8tct.jpg)
...
```javascript
{
    ...
    avatar: [File {
        ...
        size: 78540,
        path: '\%uploads\%upload_b631c6cbae362214afbe14b6e18d9f65.png',
        name: 'mm.png',
        type: 'image/png',
        hash: null,
...
[session](https://www.npmjs.com/package/koa-session)
